...
export default function Dates({ navigation, route }) {
  ...
  const getDates = async () => {
    try {
      ...
      const response = await axios.post(`http://${GLOBAL_CONFIG.SYSTEM_IP}/api/Attendance/dates`, {
        course: course
      });
      const attendanceData = response.data;
      const attended = await axios.post(`http://${GLOBAL_CONFIG.SYSTEM_IP}/api/Attendance/UserAttendance`,
