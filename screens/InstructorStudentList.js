...
export default function InstructorStudentList({ route }) {
    ...
    const fetchAdminDetails = async () => {
        try {
            const response = await axios.get(`http://${GLOBAL_CONFIG.SYSTEM_IP}/details/${course}/admins`);
    ...
    const fetchStudentDetails = async () => {
        try {
            const response = await axios.get(`http://${GLOBAL_CONFIG.SYSTEM_IP}/details/${courseId}/students`);
